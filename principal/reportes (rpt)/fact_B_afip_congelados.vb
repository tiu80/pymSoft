...
Public Class fact_B_afip_congelados
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "fact_B_afip_congelados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.fact_B_afip_congelados.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedfact_B_afip_congelados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fact_B_afip_congelados = New fact_B_afip_congelados()
        rpt.Site = Me.Site
        Return rpt
    End Function

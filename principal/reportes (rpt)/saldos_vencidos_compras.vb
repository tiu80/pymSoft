...
Public Class saldos_vencidos_compras
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "saldos_vencidos_compras.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.saldos_vencidos_compras.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedsaldos_vencidos_compras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As saldos_vencidos_compras = New saldos_vencidos_compras()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class precio_x_rubro_param
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "precio_x_rubro_param.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.precio_x_rubro_param.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedprecio_x_rubro_param
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As precio_x_rubro_param = New precio_x_rubro_param()
        rpt.Site = Me.Site
        Return rpt
    End Function

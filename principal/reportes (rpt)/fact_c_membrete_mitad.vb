...
Public Class fact_c_membrete_mitad
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "fact_c_membrete_mitad.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.fact_c_membrete_mitad.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedfact_c_membrete_mitad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fact_c_membrete_mitad = New fact_c_membrete_mitad()
        rpt.Site = Me.Site
        Return rpt
    End Function

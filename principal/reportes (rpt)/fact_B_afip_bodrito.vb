...
Public Class fact_B_afip_bodrito
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "fact_B_afip_bodrito.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Shadows Property NewGenerator() As Boolean
        Get
            Return True
        End Get
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.fact_B_afip_bodrito.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedfact_B_afip_bodrito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fact_B_afip_bodrito = New fact_B_afip_bodrito()
        rpt.Site = Me.Site
        Return rpt
    End Function

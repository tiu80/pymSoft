...
Public Class resumen_hist_ctacte
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "resumen_hist_ctacte.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.resumen_hist_ctacte.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedresumen_hist_ctacte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As resumen_hist_ctacte = New resumen_hist_ctacte()
        rpt.Site = Me.Site
        Return rpt
    End Function

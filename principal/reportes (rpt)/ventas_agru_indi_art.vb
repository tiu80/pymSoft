...
Public Class ventas_agru_indi_art
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ventas_agru_indi_art.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventas_agru_indi_art
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ventas_agru_indi_art = New ventas_agru_indi_art
        rpt.Site = Me.Site
        Return rpt
    End Function

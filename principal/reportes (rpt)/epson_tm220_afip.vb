...
Public Class epson_tm220_afip
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.epson_tm220_afip.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedepson_tm220_afip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As epson_tm220_afip = New epson_tm220_afip()
        rpt.Site = Me.Site
        Return rpt
    End Function

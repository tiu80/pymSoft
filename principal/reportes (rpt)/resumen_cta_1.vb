...
'     Versión del motor en tiempo de ejecución:2.0.50727.8922
'
...
Public Class Cachedresumen_cta_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As resumen_cta_1 = New resumen_cta_1
        rpt.Site = Me.Site
        Return rpt
    End Function

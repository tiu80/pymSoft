...
Public Class ventas_agru_indi
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.ventas_agru_indi.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedventas_agru_indi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ventas_agru_indi = New ventas_agru_indi()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class Fact_A_afip_gama
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.Fact_A_afip_gama.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedFact_A_afip_gama
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fact_A_afip_gama = New Fact_A_afip_gama()
        rpt.Site = Me.Site
        Return rpt
    End Function

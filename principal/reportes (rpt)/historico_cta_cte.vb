...
Public Class historico_cta_cte
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.historico_cta_cte.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedhistorico_cta_cte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As historico_cta_cte = New historico_cta_cte()
        rpt.Site = Me.Site
        Return rpt
    End Function

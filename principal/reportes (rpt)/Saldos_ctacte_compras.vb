...
Public Class Saldos_ctacte_compras
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Saldos_ctacte_compras.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.Saldos_ctacte_compras.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedSaldos_ctacte_compras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Saldos_ctacte_compras = New Saldos_ctacte_compras()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class fact_c_membrete
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.fact_c_membrete.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedfact_c_membrete
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fact_c_membrete = New fact_c_membrete()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class Saldos_vencidos
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.Saldos_vencidos.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedSaldos_vencidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Saldos_vencidos = New Saldos_vencidos()
        rpt.Site = Me.Site
        Return rpt
    End Function

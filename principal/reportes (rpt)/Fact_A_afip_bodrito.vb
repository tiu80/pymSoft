...
Public Class Fact_A_afip_bodrito
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Fact_A_afip_bodrito.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.Fact_A_afip_bodrito.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedFact_A_afip_bodrito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fact_A_afip_bodrito = New Fact_A_afip_bodrito()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class Fact_A_afip_erica
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.Fact_A_afip_erica.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedFact_A_afip_erica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fact_A_afip_erica = New Fact_A_afip_erica()
        rpt.Site = Me.Site
        Return rpt
    End Function

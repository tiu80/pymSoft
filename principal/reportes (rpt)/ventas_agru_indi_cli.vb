...
Public Class ventas_agru_indi_cli
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ventas_agru_indi_cli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventas_agru_indi_cli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ventas_agru_indi_cli = New ventas_agru_indi_cli
        rpt.Site = Me.Site
        Return rpt
    End Function

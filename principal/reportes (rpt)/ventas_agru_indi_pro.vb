...
Public Class ventas_agru_indi_pro
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ventas_agru_indi_pro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventas_agru_indi_pro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ventas_agru_indi_pro = New ventas_agru_indi_pro
        rpt.Site = Me.Site
        Return rpt
    End Function

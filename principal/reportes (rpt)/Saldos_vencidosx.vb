...
Public Class Saldos_vencidosx
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.Saldos_vencidosx.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedSaldos_vencidosx
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Saldos_vencidosx = New Saldos_vencidosx()
        rpt.Site = Me.Site
        Return rpt
    End Function

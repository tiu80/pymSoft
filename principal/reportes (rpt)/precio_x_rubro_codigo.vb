...
Public Class precio_x_rubro_codigo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "precio_x_rubro_codigo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.precio_x_rubro_codigo.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedprecio_x_rubro_codigo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As precio_x_rubro_codigo = New precio_x_rubro_codigo()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class stock_pedido_positivo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "stock_pedido_positivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Property FullResourceName() As String
        Get
            Return "pym.stock_pedido_positivo.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class Cachedstock_pedido_positivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As stock_pedido_positivo = New stock_pedido_positivo()
        rpt.Site = Me.Site
        Return rpt
    End Function

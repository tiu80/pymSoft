...
Public Class Form_compras
    ...
    Private Sub carga_grilla()
        ...
        If Me.lbl_iva.Text = "I.V.A 27 %" Then Me.txt_iva_inscripto.Text = Format((Me.txt_neto_gravado.Text * 27) / 100, "0.00")
    ...
    Private Sub cierra_comprobante()
        ...
        a = MessageBox.Show("Esta Seguro??", "PyMSoft", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1)
    ...
    Private Sub cargar_datos()
        ...
        Call carga_grilla()
        a = MessageBox.Show("Acepta Totales ??", "PyMsoft", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
    ...
    Private Sub guarda_comprobante()
        ...
        For i = 0 To Me.DataGridView1.Rows.Count - 1
            ...
            tot = Format(tot + Me.DataGridView1.Rows(i).Cells(2).Value, "0.00")

        Next

        xxx.instruccion = "INSERT INTO compra_tot(num1,lt1,pre1,tipo2,debito,credito,neto,imp_interno,exento,iva_ins,per_ib,per_iva,fec_emi2,fec_vto2,fec_arqueo2,total,talon2,id_cli1) VALUES ('" & Me.txt_numero.Text & "','" & Me.txt_letra.Text & "','" & Me.txt_prefijo.Text & "','" & Me.txt_tipo_fact.Text & "','" & deb & "','" & cre & "','" & sub_tot & "','" & imp & "','" & exento & "','" & iva_ins & "','" & pb & "','" & pi & "', '" & Me.dt_fec_emision.Text & "','" & Me.dt_fec_vto.Text & "','" & Me.dt_fec_arqueo.Text & "','" & tot & "','" & Me.txt_talonario_pred.Text & "','" & Me.txt_codigo.Text & "')"
        xxx.abm()

        If RTrim(Me.cmb_forma_pago.Text) = "Cta Cte" Then

            If Me.txt_tipo_fact.Text = "FC" Then

                xxx.instruccion = "INSERT INTO cta_cte_pro(id_cta,tc,lt,pre,id_cli,cli,fecha_emi,fecha_vto,debito,credito,num_fact,estado,confirma) VALUES('" & Me.txt_numero.Text & "','" & Me.txt_tipo_fact.Text & "', '" + Me.txt_letra.Text + "','" + Me.txt_prefijo.Text + "','" + Me.txt_codigo.Text + "','" + Me.txt_cliente.Text + "','" & Me.dt_fec_emision.Text & "','" & Me.dt_fec_vto.Text & "','" & tot & "', '','" & Me.txt_numero.Text & "', 'DEBE','P')"
                xxx.abm()

                If xxx.verifica = True Then
                    xxx.instruccion = "INSERT INTO cta_cte_hist_pro(num,tc,lt,pre,debito,credito,estado,fec,id_cli,cli) VALUES('" & Me.txt_numero.Text & "','" & Me.txt_tipo_fact.Text & "', '" + Me.txt_letra.Text + "','" + Me.txt_prefijo.Text + "','" & tot & "', '','DEBE','" & Me.dt_fec_emision.Text & "','" & Me.txt_codigo.Text & "','" & Me.txt_cliente.Text & "')"
                    xxx.abm()
                End If

            End If

            If Me.txt_tipo_fact.Text = "NC" Then
    ...
    Private Sub verifica_numeradores()
        ...
        comando = New SqlDataAdapter("select *from compra_cab where numero = '" & RTrim(Me.txt_numero.Text) & "' and prefijo = '" & RTrim(Me.txt_prefijo.Text) & "' and letra = '" & RTrim(Me.txt_letra.Text) & "' and tipo = '" & RTrim(Me.txt_tipo_fact.Text) & "' and id_cliente = '" & RTrim(Me.txt_codigo.Text) & "' and talon ='" & RTrim(Me.txt_talonario_pred.Text) & "'", conex)
        comando.Fill(tbl)

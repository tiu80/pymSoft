Public Class form_tipo_iva
    ...
    Private Sub cmd_actualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_actualizar.Click
        ...
        If Me.TabControl1.SelectedIndex = 0 Then
            ...
            iva.instruccion = "update art_precio set iva = '" & Me.txt_iva_ins.Text & "' where id_iva = '" & Me.txt_interno.Text & "'"
            iva.actualizar()
        ...
        If Me.TabControl1.SelectedIndex = 1 Then
            ...
            iva.instruccion = "update imp_interno set cod_int = '" & Me.txt_cod_imp_interno.Text & "', nombre = '" & Me.txt_nombre_imp_int.Text & "',monto = '" & Me.txt_importe_imp.Text & "', fec_alta ='" & Me.dt_fec_alta_imp_int.Text & "',letra ='" & Me.TextBox3.Text & "',estado ='" & Me.cmb_estado_imp_int.Text & "' where cod_int = '" & Me.txt_cod_interno1.Text & "'"
            iva.actualizar()

            iva.instruccion = "update art_precio set impuestos = '" & Me.txt_importe_imp.Text & "' where cod_imp = '" & Me.txt_cod_imp_interno.Text & "'"
            iva.actualizar()
    ...
    Private Sub cmd_eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_eliminar.Click
        ...
        If x = 6 Then
            ...
            If Me.TabControl1.SelectedIndex = 0 Then
                ...
                If Me.txt_codigo_iva.Text = 1 Or Me.txt_codigo_iva.Text = 2 Or Me.txt_codigo_iva.Text = 3 Then
                    MessageBox.Show("No se puede eliminar este campo.. consulte al administrador", "PyMsoft", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Exit Sub
                End If

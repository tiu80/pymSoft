...
Public Class Form_pendiente
    ...
    Public Sub carga_datos()
        ...
        comando = New SqlDataAdapter("select id_art2,detalle,cant from ped_det where num= '" & RTrim(form_factura.txt_numero.Text) & "' and pre ='" & RTrim(form_factura.txt_prefijo.Text) & "' and tc = '" & RTrim(form_factura.txt_tipo_fact.Text) & "' and lt = '" & RTrim(form_factura.txt_letra.Text) & "'", conex)
        comando.Fill(tbbl)

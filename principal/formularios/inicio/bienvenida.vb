    ...
    Public Sub cargar_sub_menu()
        ...
        If Form_login.cmb_usuario.Text <> "Administrador" Then
            ...
            For i = 0 To midataset.Tables("sub_menu_01").Rows.Count - 1
                ...
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Zona" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_zona.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Zona" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_zona.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Zona" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_zona.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Carga" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_carga.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Carga" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_zona.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Carga" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_cargas.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Actualiza Sucursal" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_actualizador.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Actualiza Sucursal" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_actualizador.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Actualiza Sucursal" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_actualizador.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Empleado" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_empleado.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Empleado" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_actualizador.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Alta Empleado" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_empleado.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Moneda Extranjera" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_moneda_extranjera.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Moneda Extranjera" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_actualizador.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Moneda Extranjera" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_moneda_extranjera.Visible = False
                ...
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Nota Debito" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_nota_debito.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Nota Credito" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_nota_credito.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Nota Debito" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_n_debito.Visible = False
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Ingreso Cobranza" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_recibos.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Cambio Numerador" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_numerador.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Consulta Comprobantes" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_cons_comprobantes.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Arqueo Caja" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_arqueo_caja.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Visualizador." And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_vizualiza_fact.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Consulta Recibos" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_balance_saldos.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Consulta Cta Cte" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_cons_cta_cte.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Preventa" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_factura_preventa.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Cierre Fiscal" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_cierre_fiscal.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Libro I.V.A" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_iva_ventas.Image = Me.ImageList1.Images(0)
                ...
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Transferidor pda" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_resumen_cta.BackgroundImage = Nothing
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Transferidor pda" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_resumen_cta.Image = Me.ImageList1.Images(0)
                ...
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reimpresion pda" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_reimpresion.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reimpresion pda" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_resumen_cta.BackgroundImage = Nothing
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reimpresion pda" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_reimpresion.Image = Me.ImageList1.Images(0)
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reimpresion pda" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_reimpresion.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Presupuesto" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_presupuesto.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Presupuesto" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_presupuesto.BackgroundImage = Nothing
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Presupuesto" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_presupuesto.Image = Me.ImageList1.Images(0)
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Presupuesto" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_presupuesto.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Ingreso Egreso Caja" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_ingreso_egreso.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Ingreso Egreso Caja" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_presupuesto.BackgroundImage = Nothing
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Ingreso Egreso Caja" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_presupuesto.Image = Me.ImageList1.Images(0)
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Ingreso Egreso Caja" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_ingreso_egreso.Visible = False
                ...
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reportes" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_reportes.Enabled = False
                ...
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reportes" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_reportes.Visible = False
                ...
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Resumen cuenta" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_resumen_cta.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Resumen cuenta" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_repcta_cte.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Resumen cuenta" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_resumen_cta.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Variacion Precios" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_variacion_precios.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Variacion Precios" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_repcta_cte.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Variacion Precios" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_variacion_precios.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reporte etiquetas" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_rep_etiquetas.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Resumen cuenta" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_repcta_cte.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reporte etiquetas" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_rep_etiquetas.Visible = False

                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reporte horario empleados" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_reporte_horario.Enabled = False
                'If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reporte horario empleados" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.cmd_repcta_cte.BackgroundImage = Nothing
                If RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(4)) = "Reporte horario empleados" And RTrim(midataset.Tables("sub_menu_01").Rows(i).Item(5)) = "B" Then principal.lbl_reporte_horario.Visible = False
